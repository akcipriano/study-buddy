...
class Science extends React.Component {
  ...
  componentDidMount() {
    fetch('http://localhost:3000/sciencemeetups', {
      method: 'GET'
    }).then(res => res.json())
    .then(response => {
  ...
  handleSubmit(event){
    ...
    fetch('http://localhost:3000/sciencenewmeet', {
      method: 'POST',
      body: JSON.stringify({
    ...
    return (
      <div>
        ...
        <Main>
          ...
          <strong><u>Set up a Science meet:</u></strong>
          <br /><br />
            <label>
            ...
            <label>
              Topic:&nbsp;
              <input name="topic" type="text" placeholder="ex: Anatomy" value={this.state.topic} onChange={this.handleInputChange} required/>
            </label>
            <br />
            <label>
              Place:&nbsp;
